...
func registerTestAccount(ctx context.Context) *Account {
	account := newTestAccount()
	app.RegisterAccount(ctx, account)
	return account
}

func addAccountToGroup(ctx context.Context, account *Account) *Group {
	group := newTestGroup()
...
var _ = BeforeSuite(func() {
	...
	err = tenant.CreateApplication(ctx, app)
	if err != nil {
		panic(err)
	}
